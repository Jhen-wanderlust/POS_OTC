...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').click()
time.sleep(1)
